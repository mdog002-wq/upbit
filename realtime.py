    ...
    <div class="container mx-auto max-w-7xl">
        <header class="bg-white p-6 rounded-lg shadow-md mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="https://mdog002-wq.github.io/upbit-a/" target="_self" class="bg-blue-600 hover:bg-blue-700 text-white font-bold px-4 py-1.5 rounded-lg text-sm transition-colors shadow-sm flex items-center gap-1">
                    📊 AI리포트
                </a>
            </div>
        </header>
